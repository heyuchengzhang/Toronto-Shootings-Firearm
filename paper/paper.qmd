...
date-format: long
abstract: "This paper examines firearm violence in Toronto from 2004 to 2024 using Open Data Toronto to understand its temporal and geographic patterns. Findings show an upward trend in firearm-related injuries and deaths, with incidents disproportionately concentrated in neighborhoods such as Glenfield-Jane Heights and Black Creek. Linear regression models predict continued increases if patterns persist, highlighting seasonal peaks during summer months. These results aim to guide policy and community efforts to address firearm violence through localized interventions and resource allocation."
format: pdf
toc: true
...
Using detailed data from the Open Data Toronto and statistical and geospatial tools in the R programming environment, this study examines two decades of shooting and firearm discharge data. The analysis identifies upward trends in injuries and deaths, as well as a consistent concentration of incidents in neighborhoods such as Glenfield-Jane Heights and Black Creek. These findings underscore the importance of tailored interventions that address firearm violence at both the city and neighborhood levels.
...
The Open Data Toronto's Shooting and Firearm Discharge Data [@shootings] contains all reported shooting-related occurrences. It includes incidents where projectiles were discharged from firearms as defined under the Criminal Code of Canada. Notably, the dataset encompasses two categories:
...
Toronto’s 158 neighborhoods [@neighbourhoods] serve as the geographic framework for this study. Defined based on Statistics Canada census tracts, these neighborhoods provide a consistent boundary for longitudinal analysis of socio-economic and crime-related data. An important tool for spotting trends and organizing interventions, stable borders provide comparability throughout time.

Neighborhood profiles enable targeted views into localized trends of firearm violence, supporting efforts by government and community agencies in service delivery and planning. These profiles offer a socio-economic lens to interpret variations in firearm-related incidents across the city.
...
Despite these challenges, the dataset provides a whole view of firearm violence in Toronto, offering the specificity and breadth needed for this analysis. By carefully preparing the data and addressing potential biases, this study ensures robust and reliable understanding into the temporal and spatial patterns of shootings across the city.
...
After validating the models, we extended the `Time_Index` beyond the current dataset to forecast injuries and deaths for the next 12 months. This predictive exercise provides important views into future firearm violence trends and guides proactive measures for public safety.
...
The predictive models emphasize the need for proactive strategies to mitigate firearm violence. Policymakers and law enforcement can use these findings to:
...
We offer significant findings on the temporal and spatial trends of shootings, injuries, and fatalities based on our analysis of firearm-related incidents in Toronto during the last 20 years. The results are presented through a combination of tables, figures, and statistical analyses to offer a detailed understanding of the patterns in firearm violence across the city.
...
By expanding patrols, utilizing community policing, and allocating resources based on facts, law enforcement can effectively prevent firearm violence in high-risk neighborhoods. Initiatives such as youth engagement programs, job creation schemes, and mental health support in these neighborhoods can address root causes of violence and foster safer communities. By integrating these findings into a practical strategy, policymakers and stakeholders can work toward reducing firearm-related violence in Toronto’s most affected neighborhoods, improving the safety and well-being of its residents.
...
In addition to the visualizations, @tbl-model_results summarizes the regression coefficients, indicating the intercepts and slopes for injuries and deaths. These models offer broad perspectives into the rising rates of violence involving firearms.
...
Together, the regression models, credibility intervals, and visualizations provide a robust framework for understanding and anticipating trends in firearm violence. Evidence-based initiatives for reducing deaths and injuries in Toronto are guided by these findings, which are a useful tool for stakeholders and policymakers.

# Discussion {#sec-dis}

## Seasonal patterns in Firearm Violence

Our study highlights a concerning seasonal pattern in firearm-related incidents in Toronto, with a noticeable surge during the summer months compared to the winter. To think deeper, @fig-year2223, labeled "Monthly Firearm-Related Incidents in 2022 and 2023," focuses on the monthly distribution of these incidents. This detailed visualization shows that the summer months consistently exhibit higher incident counts.
...
While the models demonstrate strong predictive capabilities, they do not account for external variables such as economic conditions, changes in policing strategies, or broader societal shifts. Incorporating these factors in future models could enhance predictive accuracy and provide a more detailed understanding of the drivers of firearm violence.
...
1. **Incorporate Additional Variables**: Expanding the scope of the analysis to include socio-economic factors, policing strategies, and community programs will provide a more detailed understanding of firearm violence.
...
3. **Develop Predictive Models**: Integrating machine learning techniques could enhance the predictive capabilities of models, accommodating non-linear relationships and a broader range of predictors.

Investigating these topics will help us better understand firearm violence and guide the creation of focused, research-based public safety initiatives.
...
- **Spatial Variables**: Geographical coordinates and neighborhood identifiers provide views into the spatial distribution of firearm incidents.
...
2. **Simpson’s Paradox**:
   Aggregating data without accounting for neighborhood-level differences or temporal trends may lead to misleading conclusions. For example, a decrease in firearm violence may mask increasing trends in specific neighborhoods.
...
1. **Incorporating Survey Data**:
   Supplementing police records with community surveys can provide views into unreported incidents and public perceptions of firearm violence. Randomized household surveys could help estimate the true prevalence of firearm-related incidents.
